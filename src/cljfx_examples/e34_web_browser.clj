(ns cljfx-examples.e34-web-browser
...
;; ====================
;;
;; This examples one additional property from web-view in order to understand when a link on a web page has been clicked.
;; See the README.md and e21-extension-lifecycle for some additional examples of this.
...
;; A well known url
(def home-url "https://www.duckduckgo.com")

;; The strategy here is to have a partial-url associated with the text field so that typing into the text field
;; does not act as a URL until the return button is pressed. The resulting url is sched to see if the (usually omitted)
